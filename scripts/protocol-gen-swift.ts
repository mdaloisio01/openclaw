...
const DEFAULTED_OPTIONAL_INIT_PARAM_ENTRIES: readonly [string, readonly string[]][] = [
  ...
  ["ConfigSetParams", ["controlPlaneManifest", "controlPlaneApproval"]],
  ["ConfigApplyParams", ["controlPlaneManifest", "controlPlaneApproval"]],
  ["ConfigPatchParams", ["controlPlaneManifest", "controlPlaneApproval"]],
  ...
  [
    "ChatSendParams",
    ["agentId", "clientSendAttemptId", "clientSendAttemptAtMs", "clientPendingSendAttempts"],
  ],
