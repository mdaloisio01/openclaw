...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "tasks.governance.apply", scope: "operator.write" },
  { name: "tasks.governance.status", scope: "operator.read" },
  { name: "tasks.governance.preview", scope: "operator.read" },
  ...
  { name: "tasks.recordProductionFlowLawfulStop", scope: "operator.write" },
  { name: "tasks.probeProductionWatchdogLifecycle", scope: "operator.write" },
  ...
  { name: "agent.falseCloseoutAdmission.probe", scope: "operator.admin", advertise: false },
