  ...
  it("mechanically denies, blocks, or withholds every required prohibited transition", async () => {
    ...
    const cases: AdversarialCase[] = [
      ...
      },
      {
        ...
        actual: override({ expiresAt: "2026-08-24T01:00:00Z" }),
        expected: expect.objectContaining({ decision: "denied", evaluatorReason: "expired" }),
      },
      {
        id: 18,
      ...
      },
      {
        ...
        actual: supervisor({
          ...
          receipt: {
            ...
            receiptId: "supervisor:adversarial-timeout",
            ...
            state: "stale",
            supervisorState: "timeout",
            failureState: "TIMED_OUT",
            sessionId: "adversarial-timeout",
            cancelled: false,
            killed: true,
            stdoutSummary: "",
            stderrSummary: "",
